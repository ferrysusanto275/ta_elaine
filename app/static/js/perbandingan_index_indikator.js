...
const create_link = (grup, indikator) => {
    return `${isi_api}/index_indikator/${indikator}/grup/${grup}`;
};
const create_perbandingan = (grup, indikator) => {
    const img_tampil = document.createElement("img");
    img_tampil.src = create_link(grup, indikator);
    return img_tampil;
};
