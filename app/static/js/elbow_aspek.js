...
const create_link = (grup, aspek1, aspek2) => {
  return `${isi_api}/kmeans_aspek/${aspek1}/${aspek2}/grup/${grup}`;
};
const create_perbandingan = (grup, aspek1, aspek2) => {
  const img_tampil = document.createElement("img");
  img_tampil.src = create_link(grup, aspek1, aspek2);
  return img_tampil;
};
