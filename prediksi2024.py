...
data2022=isi_model.getById('i2023110600081','in2023110400011',2022)['value']
data2023=isi_model.getById('i2023110600081','in2023110400011',2023)['value']
data2024=data2023
...
data = {
    ...
    'value': [isi_model.getById('i2023110600081','in2023110400011',2018)['value'],
         isi_model.getById('i2023110600081','in2023110400011',2019)['value'],
         isi_model.getById('i2023110600081','in2023110400011',2020)['value'],
         isi_model.getById('i2023110600081','in2023110400011',2021)['value'],
         isi_model.getById('i2023110600081','in2023110400011',2022)['value'],
         isi_model.getById('i2023110600081','in2023110400011',2023)['value'],
         data2024]
}
